...
import com.duc.karaoke_app.feature_home.presentation.ui.adapter.ProfileAdapter
import com.duc.karaoke_app.core.utils.CustomBottomSheet
...
class ProfileFragment : Fragment() {
    ...
    private fun animateAllProgressBars(stats: ActivityStatisticsResponse) {
    ...
    private fun animateProgressBarSmooth(
        ...
        pb.progress = 0
        ObjectAnimator.ofInt(pb, "progress", 0, end)
            .apply {
                duration = durationMs
